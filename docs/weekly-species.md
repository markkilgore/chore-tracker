...
New lesson charts use layout v2 with up to 12 chore rows per Letter page, reserving space for a readable lesson. More chores continue onto another page with the same lesson. QR identifiers and occurrence-linked checkboxes are preserved. Existing saved charts retain their original layout and content; generate a new chart to include the lesson.
